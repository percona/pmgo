...
func (_m *MockDialer) Dial(_param0 string) (pmgo.SessionManager, error) {
...
func (_m *MockDialer) DialWithInfo(_param0 *mgo_v2.DialInfo) (pmgo.SessionManager, error) {
...
func (_m *MockDialer) DialWithTimeout(_param0 string, _param1 time.Duration) (pmgo.SessionManager, error) {
