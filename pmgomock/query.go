...
import (
	...
	pmgo_git "github.com/tenling/pmgo.git"
...
func (m *MockQueryManager) Batch(n int) pmgo_git.QueryManager {
	ret := m.ctrl.Call(m, "Batch", n)
	ret0, _ := ret[0].(pmgo_git.QueryManager)
	return ret0
}
...
func (m *MockQueryManager) Comment(comment string) pmgo_git.QueryManager {
...
func (m *MockQueryManager) Hint(indexKey ...string) pmgo_git.QueryManager {
	varargs := []interface{}{}
...
func (m *MockQueryManager) Iter() pmgo_git.IterManager {
	ret := m.ctrl.Call(m, "Iter")
	ret0, _ := ret[0].(pmgo_git.IterManager)
	return ret0
}
...
func (m *MockQueryManager) Limit(n int) pmgo_git.QueryManager {
...
func (m *MockQueryManager) LogReplay() pmgo_git.QueryManager {
...
func (m *MockQueryManager) Prefetch(p float64) pmgo_git.QueryManager {
...
func (m *MockQueryManager) Select(selector interface{}) pmgo_git.QueryManager {
...
func (m *MockQueryManager) SetMaxScan(n int) pmgo_git.QueryManager {
...
func (m *MockQueryManager) SetMaxTime(d time.Duration) pmgo_git.QueryManager {
...
func (m *MockQueryManager) Skip(n int) pmgo_git.QueryManager {
...
func (m *MockQueryManager) Snapshot() pmgo_git.QueryManager {
...
func (m *MockQueryManager) Sort(fields ...string) pmgo_git.QueryManager {
	varargs := []interface{}{}
...
func (m *MockQueryManager) Tail(timeout time.Duration) pmgo_git.IterManager {
